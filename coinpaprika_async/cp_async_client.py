...
class Client:
    ...
    async def __request(self, path: str, query_params: dict[str] = None) -> ResponseObject | None:
    ...
    async def __request_api(self, path: str, params: dict[str] = None) -> ResponseObject | None:

        return await self.__request(path, params)

    async def __call_api(self, path: str, params: dict[str] = None) -> ResponseObject | None:
    ...
    async def candle(self, coin_id: str, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api(f"coins/{coin_id}/ohlcv/latest", params)

    async def candles(self, coin_id: str, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api(f"coins/{coin_id}/ohlcv/historical", params)

    async def today(self, coin_id: str, params: dict[str] = None) -> ResponseObject | None:
    ...
    async def tags(self, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api("tags", params)

    async def tag(self, tag_id: str, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api(f"tags/{tag_id}", params)

    async def tickers(self, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api("tickers", params)

    async def ticker(self, coin_id: str, params: dict[str] = None) -> ResponseObject | None:
    ...
    async def exchange_list(self, params: dict[str] = None) -> ResponseObject | None:
    ...
    async def exchange_markets(self, exchange_id: str, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api(f"exchanges/{exchange_id}/markets", params)

    async def search(self, params: dict[str] = None) -> ResponseObject | None:

        return await self.__call_api("search", params)

    async def price_converter(self, params: dict[str] = None) -> ResponseObject | None:
